        ...
        for phase in ['train', 'val']:
            ...
            for sample in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase=='train'):
                    ...
                    PFFx32_2to1, PFFx32_1to2 = model(imgListA32, imgListB32) # forward (2to1) & backward (1to2) flow
                    UVx32_1to2 = filterFlow2UV(PFFx32_1to2, device)    
                    UVx32_2to1 = filterFlow2UV(PFFx32_2to1, device)               
                    
                    # B==F1to2 x A, A== F2to1 x (F1to2 x A)
                    lossFlow4bidir = loss_bidir(UVx32_1to2, UVx32_2to1, biDirBorder2Ignore)  # loss_bidir(FF_AtoB, FF_BtoA)
                    # (AB, BA) --> (backward, forward) flow
                    loss += lossFlow4bidir
                    running_loss_bidir_32 += lossFlow4bidir.item()*N
                    
                    DiffABA = (loss_bidir.DiffABA.detach()<occThresh).type(torch.FloatTensor) # occlusion map on A
                    DiffABA = Variable(DiffABA).to(device)
                    DiffBAB = (loss_bidir.DiffBAB.detach()<occThresh).type(torch.FloatTensor) # occlusion map on B
                    DiffBAB = Variable(DiffBAB).to(device)
                                        
                    
                    lossRecB32 = loss_pixelReconstruction(imgListA32, imgListB32, PFFx32_1to2, DiffBAB) # mask for B
                    loss += lossRecB32
                    lossRecA32 = loss_pixelReconstruction(imgListB32, imgListA32, PFFx32_2to1, DiffABA) # mask for A
                    loss += lossRecA32
                    lossFlow4ReconB = loss_warp4reconstruction(imgListA32, imgListB32, PFFx32_1to2, DiffBAB) 
                    ...
                    lossFlow4ReconA = loss_warp4reconstruction(imgListB32, imgListA32, PFFx32_2to1, DiffABA)
                    ...
                    loss += lossSmooth2to1
                    loss += lossSmooth1to2
                    lossSmooth2to1UV = loss_filterSmoothness(UVx32_2to1)
                    lossSmooth1to2UV = loss_filterSmoothness(UVx32_1to2)
                    loss += lossSmooth2to1UV
                    loss += lossSmooth1to2UV
                    ...
                    lossFlow4bidir = loss_bidir(UVx16_1to2tmp, UVx16_2to1, biDirBorder2Ignore+2)                    
                    loss += lossFlow4bidir
                    ...
                    lossFlow4bidir = loss_bidir(UVx16_1to2, UVx16_2to1tmp, biDirBorder2Ignore+2)                    
                    loss += lossFlow4bidir
                    ...
                    lossRecA16 = loss_pixelReconstruction(recImgA32x2, imgListA16, PFFx16_2to1, DiffABA)
                    loss += lossRecA16
                    lossRecB16 = loss_pixelReconstruction(recImgB32x2, imgListB16, PFFx16_1to2, DiffBAB)
                    loss += lossRecB16
                    lossFlow4ReconA = loss_warp4reconstruction(recImgA32x2, imgListA16, PFFx16_2to1, DiffABA) 
                    #UVx16_2to1 = loss_warp4reconstruction.UVgrid
                    loss += lossFlow4ReconA
                    lossFlow4ReconB = loss_warp4reconstruction(recImgB32x2, imgListB16, PFFx16_1to2, DiffBAB)
                    ...
                    loss += lossSmooth2to1
                    loss += lossSmooth1to2
                    lossSmooth2to1UV = loss_filterSmoothness(UVx16_2to1tmp)
                    lossSmooth1to2UV = loss_filterSmoothness(UVx16_1to2)
                    loss += lossSmooth2to1UV
                    loss += lossSmooth1to2UV
                    ...
                    lossFlow4bidir = loss_bidir(UVx8_1to2tmp, UVx8_2to1, biDirBorder2Ignore+4)                    
                    loss += lossFlow4bidir
                    ...
                    lossFlow4bidir = loss_bidir(UVx8_1to2, UVx8_2to1tmp, biDirBorder2Ignore+4)                    
                    loss += lossFlow4bidir
                    lossLaziness_1to2 = loss_laziness(UVx8_1to2)*0.01
                    loss += lossLaziness_1to2
                    
                    
                    lossRecA8 = loss_pixelReconstruction(recImgA16x2, imgListA8, PFFx8_2to1, DiffABA)
                    loss += lossRecA8
                    lossRecB8 = loss_pixelReconstruction(recImgB16x2, imgListB8, PFFx8_1to2, DiffBAB)
                    loss += lossRecB8
                    lossFlow4ReconA = loss_warp4reconstruction(recImgA16x2, imgListA8, PFFx8_2to1, DiffABA) 
                    UVx8_2to1 = loss_warp4reconstruction.UVgrid
                    loss += lossFlow4ReconA
                    lossFlow4ReconB = loss_warp4reconstruction(recImgB16x2, imgListB8, PFFx8_1to2, DiffBAB)
                    ...
                    loss += lossSmooth2to1
                    loss += lossSmooth1to2
                    lossSmooth2to1UV = loss_filterSmoothness(UVx8_2to1tmp)
                    lossSmooth1to2UV = loss_filterSmoothness(UVx8_1to2)
                    loss += lossSmooth2to1UV
                    loss += lossSmooth1to2UV
                    ...
                    lossFlow4bidir = loss_bidir(UVx4_1to2tmp, UVx4_2to1, biDirBorder2Ignore+8)                    
                    loss += lossFlow4bidir
                    ...
                    lossFlow4bidir = loss_bidir(UVx4_1to2, UVx4_2to1tmp, biDirBorder2Ignore+8)                    
                    loss += lossFlow4bidir
                    ...
                    lossRecA4 = loss_pixelReconstruction(recImgA8x2, imgListA4, PFFx4_2to1, DiffABA)
                    loss += lossRecA4
                    lossRecB4 = loss_pixelReconstruction(recImgB8x2, imgListB4, PFFx4_1to2, DiffBAB)
                    loss += lossRecB4
                    lossFlow4ReconA = loss_warp4reconstruction(recImgA8x2, imgListA4, PFFx4_2to1, DiffABA) 
                    UVx4_2to1 = loss_warp4reconstruction.UVgrid
                    loss += lossFlow4ReconA
                    lossFlow4ReconB = loss_warp4reconstruction(recImgB8x2, imgListB4, PFFx4_1to2, DiffBAB)
                    ...
                    loss += lossSmooth2to1
                    loss += lossSmooth1to2
                    lossSmooth2to1UV = loss_filterSmoothness(PFFx4_2to1tmp)
                    lossSmooth1to2UV = loss_filterSmoothness(UVx4_1to2)
                    loss += lossSmooth2to1UV
                    loss += lossSmooth1to2UV
                    ...
                    lossFlow4bidir = loss_bidir(UVx2A_1to2, UVx2A_2to1tmp, biDirBorder2Ignore+10)                    
                    loss += lossFlow4bidir
                    ...
                    lossRecA = loss_pixelReconstruction(recImgA4x2, imgListA2, PFFx2A_1to2, DiffABA)
                    loss += lossRecA
                    running_loss_reconstruction += lossRecA.item()*N                    
                    
                    lossFlow4ReconA = loss_warp4reconstruction(recImgA4x2, imgListA2, PFFx2A_1to2, DiffABA)
                    ...
                    lossSmooth1to2UV = loss_filterSmoothness(UVx2A_1to2)
                    loss += lossSmooth1to2UV   
                    running_loss_filterSmoothness += lossSmooth1to2UV.item()*N                      
                                       
                    #loss_imageGradientA = loss_imageGradient(reconsturctedImageA, imgListA2, DiffABA)*N
                    ...
                    lossFlow4bidir = loss_bidir(UVx2B_1to2, UVx2B_2to1tmp, biDirBorder2Ignore+10)                    
                    loss += lossFlow4bidir
                    ...
                    loss += lossLaziness_2to1
                    lossRecB = loss_pixelReconstruction(recImgB4x2, imgListB2, PFFx2B_1to2, DiffBAB)
                    loss += lossRecB
                    running_loss_reconstruction += lossRecB.item()*N
                    
                    lossFlow4ReconB = loss_warp4reconstruction(recImgB4x2, imgListB2, PFFx2B_1to2, DiffBAB)
                    ...
                    lossSmooth1to2UV = loss_filterSmoothness(UVx2B_1to2)
                    loss += lossSmooth1to2UV
                    running_loss_filterSmoothness += lossSmooth1to2UV.item()*N
                                       
                    #loss_imageGradientB = loss_imageGradient(reconsturctedImageB, imgListB2, DiffBAB)*N
