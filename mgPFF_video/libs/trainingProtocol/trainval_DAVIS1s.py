...
def train_model(model, Model16, Model8, Model4, Model2, dataloaders, dataset_sizes, 
                loss_pixelReconstruction, 
                warpImgWithScale1, warpImgWithScale2, warpImgWithScale4, warpImgWithScale8, warpImgWithScale16,
    ...
    for epoch in range(num_epochs):        
        ...
        for phase in ['train', 'val']:
            ...
            running_loss_reconstructionX8 = 0.0
            running_loss_reconstructionX16 = 0.0
            ...
            running_loss_imageGradientX8 = 0.0
            running_loss_imageGradientX16 = 0.0
            
            
            # Iterate over data.
            iterCount,sampleCount = 0, 0
            for sample in dataloaders[phase]:
                imgListA1,imgListB1,imgListA2,imgListB2,imgListA4,imgListB4,imgListA8,imgListB8,imgListA16,imgListB16=sample
                ...
                with torch.set_grad_enabled(phase=='train'):
                    ...
                    PFFx2_2to1, _ = Model2(imgListA2, recImgA4x2)
                    ...
                    warpImgWithScale4.device = supplDevice
                    warpImgWithScale2.device = supplDevice
                    recImgA16x16 = warpImgWithScale16(imgListB1, PFFx16_2to1.to(supplDevice))
                    recImgA8x8 = warpImgWithScale8(recImgA16x16, PFFx8_2to1.to(supplDevice))
                    recImgA4x4 = warpImgWithScale4(recImgA8x8, PFFx4_2to1.to(supplDevice))
                    recImgA2x2 = warpImgWithScale2(recImgA4x4, PFFx2_2to1.to(supplDevice))                                        
                    recImgA2x2 = recImgA2x2.detach().to(device)
                    
                    model.to(device)
                    imgListA1 = imgListA1.to(device)
                    imgListB1 = imgListB1.to(device)
                    embFeature2_to_1, embFeature1_to_2 = model(imgListA1, recImgA2x2) 
                    lossRec1to2 = loss_pixelReconstruction(imgListA1, recImgA2x2, embFeature1_to_2)
                    reconsturctedImage2 = loss_pixelReconstruction.reconstructImage
                    lossRec2to1 = loss_pixelReconstruction(recImgA2x2, imgListA1, embFeature2_to_1)
                    ...
                    lossFlow4Recon1to2 = loss_warp4reconstruction(imgListA1, recImgA2x2, embFeature1_to_2)
                    loss += lossFlow4Recon1to2
                    lossFlow4Recon2to1 = loss_warp4reconstruction(recImgA2x2, imgListA1, embFeature2_to_1)
                    loss += lossFlow4Recon2to1
                    running_loss_flow4warpRecon += lossFlow4Recon1to2.item()*imgListA1.size(0)
                    running_loss_flow4warpRecon += lossFlow4Recon2to1.item()*imgListA1.size(0)
                    ...
                    loss += lossSmooth2to1
                    loss += lossSmooth1to2
                    running_loss_filterSmoothness += lossSmooth2to1.item()*imgListA1.size(0)
                    running_loss_filterSmoothness += lossSmooth1to2.item()*imgListA1.size(0)                            
                                       
                    loss_imageGradient2to1 = weight4ImGrad*loss_imageGradient(reconsturctedImage1, 
                                                                              imgListA2)*imgListA1.size(0)
                    loss_imageGradient1to2 = weight4ImGrad*loss_imageGradient(reconsturctedImage2,
                                                                              recImgA4x2)*imgListA1.size(0)
                    loss += loss_imageGradient2to1
                    loss += loss_imageGradient1to2
                    running_loss_imageGradient += loss_imageGradient2to1.item()*imgListA1.size(0)
                    running_loss_imageGradient += loss_imageGradient1to2.item()*imgListA1.size(0)
