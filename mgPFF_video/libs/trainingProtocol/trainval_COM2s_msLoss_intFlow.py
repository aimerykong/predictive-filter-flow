        ...
        for phase in ['train', 'val']:
            ...
            for sample in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase=='train'):
                    ...
                    UVx32_1to2 = loss_warp4reconstruction.UVgrid.detach().type(
                    ...
                    UVx32_2to1 = loss_warp4reconstruction.UVgrid.detach().type(
                        torch.LongTensor).type(torch.FloatTensor).to(device)
                    ...
                    '''
                    #recImgA32x2 = warpImgWithScale2(imgListB16, PFFx32_2to1).detach()
                    #recImgB32x2 = warpImgWithScale2(imgListA16, PFFx32_1to2).detach()
                    recImgA32x4 = warpImgWithScale4(imgListB8, PFFx32_2to1).detach()
                    recImgB32x4 = warpImgWithScale4(imgListA8, PFFx32_1to2).detach()
                    recImgA32x8 = warpImgWithScale8(imgListB4, PFFx32_2to1).detach()
                    recImgB32x8 = warpImgWithScale8(imgListA4, PFFx32_1to2).detach()
                    recImgA32x16 = warpImgWithScale16(imgListB2, PFFx32_2to1).detach()
                    recImgB32x16 = warpImgWithScale16(imgListA2, PFFx32_1to2).detach()                    
                    '''                    
                    ...
                    '''
                    recImgA16x2 = warpImgWithScale2(recImgA32x4, PFFx16_2to1).detach()
                    recImgB16x2 = warpImgWithScale2(recImgB32x4, PFFx16_1to2).detach()
                    recImgA16x4 = warpImgWithScale4(recImgA32x8, PFFx16_2to1).detach()
                    recImgB16x4 = warpImgWithScale4(recImgB32x8, PFFx16_1to2).detach()
                    recImgA16x8 = warpImgWithScale8(recImgA32x16, PFFx16_2to1).detach()
                    recImgB16x8 = warpImgWithScale8(recImgB32x16, PFFx16_1to2).detach()
                    '''
                    ...
                    '''
                    recImgA8x2 = warpImgWithScale2(recImgA16x4, PFFx8_2to1).detach()
                    recImgB8x2 = warpImgWithScale2(recImgB16x4, PFFx8_1to2).detach()
                    recImgA8x4 = warpImgWithScale4(recImgA16x8, PFFx8_2to1).detach()
                    recImgB8x4 = warpImgWithScale4(recImgB16x8, PFFx8_1to2).detach()
                    '''
                    ...
                    '''
                    recImgA4x2 = warpImgWithScale2(recImgA8x4, PFFx4_2to1).detach() 
                    recImgB4x2 = warpImgWithScale2(recImgB8x4, PFFx4_1to2).detach()                                     
                    '''
