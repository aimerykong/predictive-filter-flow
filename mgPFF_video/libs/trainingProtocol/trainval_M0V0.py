            ...
            for sample in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase=='train'):
                    if phase=='train':  # backward + optimize only if in training phase
                        ...
                        lossRec1to2 = loss_pixelReconstruction(imgListA16, imgListB16, embFeature1_to_2)
                        reconsturctedImage2 = loss_pixelReconstruction.reconstructImage                        
                        lossRec2to1 = loss_pixelReconstruction(imgListB16, imgListA16, embFeature2_to_1)
