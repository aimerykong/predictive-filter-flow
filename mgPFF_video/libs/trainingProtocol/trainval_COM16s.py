...
def train_model(model, Model32, dataloaders, dataset_sizes, 
        ...
        for phase in ['train', 'val']:
            ...
            for sample in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase=='train'):
                    ...
                    PFFx32_2to1, PFFx32_1to2 = Model32(imgListA32, imgListB32)
                    ...
                    loss_imageGradientA = loss_imageGradient(reconsturctedImageA, imgListA16)*N
                    ...
                    loss_imageGradientA = loss_imageGradient(reconsturctedImageB,imgListB16)*N
                    loss += loss_imageGradientA                    
                    running_loss_imageGradient += loss_imageGradientA.item()*N
