        ...
        for phase in ['train', 'val']:
            ...
            for sample in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase=='train'):
                    ...
                    loss += lossFlow4bidir
                    lossLaziness_2to1 = loss_laziness(UVx16_2to1)
                    loss += lossLaziness_2to1
                    ...
                    loss += lossFlow4bidir
                    lossLaziness_1to2 = loss_laziness(PFFx16_1to2)
                    loss += lossLaziness_1to2
                    ...
                    loss += lossFlow4bidir
                    lossLaziness_2to1 = loss_laziness(UVx8_2to1)
                    loss += lossLaziness_2to1
                    ...
                    loss += lossFlow4bidir
                    lossLaziness_1to2 = loss_laziness(UVx8_1to2)
                    loss += lossLaziness_1to2
                    ...
                    loss += lossFlow4bidir
                    lossLaziness_2to1 = loss_laziness(UVx4_2to1)
                    loss += lossLaziness_2to1
                    ...
                    loss += lossFlow4bidir
                    lossLaziness_1to2 = loss_laziness(UVx4_1to2)
                    loss += lossLaziness_1to2
                    ...
                    loss += lossFlow4bidir
                    lossLaziness_1to2 = loss_laziness(UVx2A_1to2)
                    loss += lossLaziness_1to2
                    ...
                    loss += lossFlow4bidir
                    lossLaziness_2to1 = loss_laziness(UVx2B_1to2)
                    loss += lossLaziness_2to1
