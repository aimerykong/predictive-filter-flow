    ...
    for epoch in range(num_epochs):        
        ...
        for phase in ['train', 'val']:
            ...
            for sample in dataloaders[phase]:                
                ...
                print2screen_avgLoss_imgGradX2 = running_loss_imageGradientX2/sampleCount
                
                       
                del loss
                if iterCount%100==0:
                    print('\t{}/{} loss: {:.4f} Rec:{:.3f}, RecX2:{:.3f}, Smooth:{:.3f}, Sparse:{:.3f}, imGrad:{:.3f}, imGradX2:{:.3f}'.
                          format(
                              iterCount, 
                              ...
                              print2screen_avgLoss_imgGradX2)                          
                         )
                    fn = open(log_filename,'a')        
                    fn.write('\t{}/{} loss: {:.4f} Rec:{:.3f}, RecX2:{:.3f}, Smooth:{:.3f}, Sparse:{:.3f}, imGrad:{:.3f}, imGradX2:{:.3f}\n'.
                             format(
                                 iterCount, 
                                 len(dataloaders[phase]), 
                                 print2screen_avgLoss, print2screen_avgLoss_Rec, 
