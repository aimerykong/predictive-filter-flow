    ...
    for epoch in range(num_epochs):        
        ...
        for phase in ['train', 'val']:
            ...
            for sample in dataloaders[phase]:
                imgListA4,imgListB4,imgListA8,imgListB8 = sample[:4]
                imgListA16,imgListB16,imgListA32,imgListB32 = sample[4:]                
                ...
                with torch.set_grad_enabled(phase=='train'):
                    ...
                    _, PFFx4A_1to2 = model(recImgA8x2, imgListA4) 
                    lossRecA = loss_pixelReconstruction(recImgA8x2, imgListA4, PFFx4A_1to2)
                    #reconsturctedImageA = loss_pixelReconstruction.reconstructImage
                    #reconsturctedImageA = warpImgWithScale1(recImgA8x2, PFFx4A_1to2)   
                    loss += lossRecA
                    running_loss_reconstruction += lossRecA.item()*N                    
                    
                    lossFlow4ReconA = loss_warp4reconstruction(recImgA8x2, imgListA4, PFFx4A_1to2)
                    ...
                    #lossSmooth2to1A = loss_filterSmoothness(PFFx4A_2to1)
                    lossSmooth1to2A = loss_filterSmoothness(PFFx4A_1to2)
                    ...
                    loss_imageGradientA = loss_imageGradient(reconsturctedImageA, imgListA4)*N
                    ...
                    _, PFFx4B_1to2 = model(recImgB8x2, imgListB4) 
                    lossRecB = loss_pixelReconstruction(recImgB8x2, imgListB4, PFFx4B_1to2)
                    #reconsturctedImageB = loss_pixelReconstruction.reconstructImage
                    #reconsturctedImageB = warpImgWithScale1(recImgB8x2, PFFx4B_1to2)  
                    loss += lossRecB
                    running_loss_reconstruction += lossRecB.item()*N
                    
                    lossFlow4ReconB = loss_warp4reconstruction(recImgB8x2, imgListB4, PFFx4B_1to2)
                    ...
                    #lossSmooth2to1B = loss_filterSmoothness(PFFx4B_2to1)
                    lossSmooth1to2B = loss_filterSmoothness(PFFx4B_1to2)
                    ...
                    loss_imageGradientB = loss_imageGradient(reconsturctedImageB, imgListB4)*N
