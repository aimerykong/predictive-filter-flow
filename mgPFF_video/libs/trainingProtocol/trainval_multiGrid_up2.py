    ...
    for epoch in range(num_epochs):        
        ...
        for phase in ['train', 'val']:
            ...
            for sample in dataloaders[phase]:                
                imgListA, imgListB, imgListA4, imgListB4, imgListA8, imgListB8 = sample
                ...
                with torch.set_grad_enabled(phase=='train'):
                    ...
                    if True:
                        ...
                        pre2to1_up2 = pre2to1_up2.contiguous().view(NCHW[0], ksize*upFactorX*ksize*upFactorX, NCHW[2], NCHW[3])
                        ...
                        pre1to2_up2 = pre1to2_up2.contiguous().view(NCHW[0], ksize*upFactorX*ksize*upFactorX, NCHW[2], NCHW[3])
                        pre1to2_up2 = pre1to2_up2/upFactorX/upFactorX
                        
                        
                        
                        
                        lossRec1to2 = loss_pixelReconstruction(imgListA8, imgListB8, embFeature1_to_2, phase)
                        reconsturctedImage2 = loss_pixelReconstruction.reconstructImage                        
                        lossRec2to1 = loss_pixelReconstruction(imgListB8, imgListA8, embFeature2_to_1, phase)
                        ...
                        lossRec1to2_up2 = loss_pixelReconstruction(recImgB_x2, imgListB4, embFeature1_to_2_up2, phase)
                        reconsturctedImage2_up2 = loss_pixelReconstruction.reconstructImage                        
                        lossRec2to1_up2 = loss_pixelReconstruction(recImgA_x2, imgListA4, embFeature2_to_1_up2, phase)
                        reconsturctedImage1_up2 = loss_pixelReconstruction.reconstructImage
                        loss += lossRec1to2_up2
                        loss += lossRec2to1_up2
                        #running_loss_reconstruction += lossRec1to2_up2.item()*imgListA8.size(0)
                        #running_loss_reconstruction += lossRec2to1_up2.item()*imgListA8.size(0)                        
                        ...
                        loss_imageGradient2to1 = loss_imageGradient(reconsturctedImage1, imgListA8)*imgListA8.size(0)
                        loss_imageGradient1to2 = loss_imageGradient(reconsturctedImage2, imgListB8)*imgListA8.size(0)
                ...
                print2screen_avgLoss_RecX2 = running_loss_reconstructionX2/sampleCount
                
                       
                del loss
                if iterCount%100==0:
                    print('\t{}/{} loss: {:.6f} l-Rec:{:.4f}, l-RecX2:{:4f}, l-Smooth:{:.4f}, l-Sparse:{:.4f}, l-imgGrad:{:.4f}'.
                          format(
                              iterCount, 
                              len(dataloaders[phase]), 
                              print2screen_avgLoss, print2screen_avgLoss_Rec, 
                              print2screen_avgLoss_RecX2,
                              print2screen_avgLoss_Smooth,
                              print2screen_avgLoss_Sparse,
                              print2screen_avgLoss_imgGrad)                          
                         )
                    fn = open(log_filename,'a')        
                    fn.write('\t{}/{} loss: {:.6f} l-Rec:{:.4f}, l-RecX2:{:4f}, l-Smooth:{:.4f}, l-Sparse:{:.4f}, l-imgGrad:{:.4f}\n'.
                             format(
                                 iterCount, 
                                 len(dataloaders[phase]), 
                                 print2screen_avgLoss, print2screen_avgLoss_Rec, 
