            ...
            for sample in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase=='train'):
                    if phase=='train':  # backward + optimize only if in training phase
                        ...
                        lossRec1to2 = loss_pixelReconstruction(img1, img2, embFeature1_to_2, phase)
                        reconsturctedImage2 = loss_pixelReconstruction.reconstructImage                        
                        lossRec2to1 = loss_pixelReconstruction(img2, img1, embFeature2_to_1, phase)
                        ...
                        loss_imageGradient2to1 = loss_imageGradient(reconsturctedImage1, img1)*img1.size(0)
                        loss_imageGradient1to2 = loss_imageGradient(reconsturctedImage2, img2)*img1.size(0)
                        loss += loss_imageGradient2to1
                        loss += loss_imageGradient1to2
                        running_loss_imageGradient += loss_imageGradient2to1.item()*img1.size(0)
                        running_loss_imageGradient += loss_imageGradient1to2.item()*img1.size(0)
