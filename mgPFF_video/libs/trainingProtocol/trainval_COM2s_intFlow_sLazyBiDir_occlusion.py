        ...
        for phase in ['train', 'val']:
            ...
            for sample in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase=='train'):
                    ...
                    lossFlow4bidir = loss_bidir(UVx32_1to2, UVx32_2to1)  # loss_bidir(FF_AtoB, FF_BtoA)
                    ...
                    lossFlow4bidir = loss_bidir(UVx16_1to2tmp, UVx16_2to1)                    
                    loss += lossFlow4bidir
                    ...
                    lossFlow4bidir = loss_bidir(UVx8_1to2tmp, UVx8_2to1)                    
                    loss += lossFlow4bidir
                    ...
                    lossFlow4bidir = loss_bidir(UVx4_1to2tmp, UVx4_2to1)                    
                    loss += lossFlow4bidir
