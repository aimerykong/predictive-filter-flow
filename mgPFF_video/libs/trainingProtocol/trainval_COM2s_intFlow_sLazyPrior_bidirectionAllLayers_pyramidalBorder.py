        ...
        for phase in ['train', 'val']:
            ...
            for sample in dataloaders[phase]:
                ...
                with torch.set_grad_enabled(phase=='train'):
                    ...
                    lossFlow4bidir = loss_bidir(UVx32_2to1, UVx32_1to2, biDirBorder2Ignore)
                    ...
                    lossFlow4bidir = loss_bidir(UVx16_2to1, UVx16_1to2tmp, biDirBorder2Ignore+2)                    
                    loss += lossFlow4bidir
                    ...
                    lossFlow4bidir = loss_bidir(UVx8_2to1, UVx8_1to2tmp, biDirBorder2Ignore+4)                    
                    loss += lossFlow4bidir
                    ...
                    lossFlow4bidir = loss_bidir(UVx4_2to1, UVx4_1to2tmp, biDirBorder2Ignore+8)                    
                    loss += lossFlow4bidir
